    ...
    <div style={{ position: 'fixed', right: 0, top: 0, bottom: 0, width: 500, background: '#fff', borderLeft: '1px solid var(--border)', boxShadow: '-12px 0 48px rgba(0,0,0,0.07)', zIndex: 500, overflowY: 'auto', display: 'flex', flexDirection: 'column' }}>
      <div style={{ padding: '1.5rem 1.75rem 1.25rem', borderBottom: '1px solid var(--border)' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
          ...
          <div style={{ display: 'flex', gap: 8 }}>
            <button onClick={onEdit} style={{ padding: '0.4rem 0.9rem', fontSize: 13, fontWeight: 500, background: 'var(--bg)', border: '1px solid var(--border-2)', borderRadius: 8, cursor: 'pointer', color: 'var(--text-2)' }}>Edit</button>
      ...
      <div style={{ padding: '1.25rem 1.75rem', flex: 1 }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10 }}>
          ...
          <button onClick={openNewLoc} style={{ fontSize: 12, fontWeight: 600, background: 'none', border: '1px solid var(--border-2)', borderRadius: 6, padding: '0.2rem 0.5rem', cursor: 'pointer', color: 'var(--text-2)' }}>+ Add</button>
        </div>
